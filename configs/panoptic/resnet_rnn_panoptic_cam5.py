...
model = dict(
    ...
    backbone=backbone,
    pretrained="/nfs/hpc/share/subramav/CV2/tempo/checkpoints/pose_resnet50_panoptic.pth.tar",
    freeze_2d=False,
    use_2d_hmaps=False,
...
data_root = '/nfs/hpc/share/subramav/CV2/panoptic-toolbox/scripts/'
data = dict(
    samples_per_gpu=1,
    workers_per_gpu=12,
    pin_memory=True,
